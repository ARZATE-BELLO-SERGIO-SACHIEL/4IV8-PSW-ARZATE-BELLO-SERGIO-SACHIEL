...
<html>
    ...
    <body>
        ...
        <div>
            ...
            <form name="agregar" action="registroh.jsp" onsubmit="return validar(this)" action="formulario.html">
                <table>
                    <thead>
                    <th>
                ...
                <tr>
                    ...
                    <td><input class="text" onkeypress="return validarL(event)"  type="text" name="nombreh"></td>
